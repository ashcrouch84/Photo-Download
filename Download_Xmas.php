...
<meta charset="utf-8">
<title>Download Your Christmas Photos</title>
...
$(document).ready(function(){
    $('.endDateSelect').click(function(e){
       ...
       let endDay = parseInt($(this).val()) + startDay;
       
       let endMonth = endDay > lastDayOfMonth ? startMonth + 1 : startMonth;
       ...
       const startFull = startYear + '-' + startMonth + '-' + startDay;
       const endFull = endYear +'-'+ endMonth + '-' + endDay;
       
       $('#endDateFull').val(endFull);
       $('#startDate').val(startFull);
    });
});
</script>
...
<body>
	<center>
		<div class="container py-4">
				<h1>Download your Christmas Photos</h1>
				<div class="mb-3">
					Please enter your email address and reference number below to download the photos you brought on the day.<br />
					<br />
					
					
					<strong>To save your photo's please right click on the photo and click "save" </strong><br />
					<br />
					<p><span class="emphasized">It may take up to 72 hours for your pictures to be uploaded</span></p>
				</div>
				
		<div class="breadcrumbWrap d-none">
			<div class="container">
						<ol class="breadcrumb">
					<li class="breadcrumb-item "><a href="/"><i class="fa fa-home"></i></a></li>
													<li class="breadcrumb-item "><a  href="/book">Book</a></li>
													<li class="breadcrumb-item active"><a   aria-current="page" tabindex="-1">Birthday Parties</a></li>
							</ol>
			</div>
		</div>
						...
						if ($open = opendir($directory))
						{
							...
							if ($countsearchterms == 1)
							{
								while (($file = readdir($open)) !== false)
								{
									...
									if ((strpos("$file",  "$search[0]") !== false) && (($fileextension == "jpg") || ($fileextension == "jpeg") || ($fileextension == "png") || ($fileextension == "bmp")))
										{
											$array[] += "$file";
											echo "<img style='width: 1200px;' src='https://4k-photos.co.uk/Lcyg1xRbij3xfckDV9HMlvG2vZHfhDbvoikgcXLb5Lnn7GQQcYpVGt63kDkLIkpA/$fileoriginal' alt='Christmas 1' class='center'>". "<br><hr>";
										}
								}
							}
							else if ($countsearchterms == 2) 
							{
								while (($file = readdir($open)) !== false)
								{
									...
									if (((strpos("$file",  "$search[0]") !== false) && (strpos("$file",  "$search[1]") !== false)) && (($fileextension == "jpg") || ($fileextension == "jpeg") || ($fileextension == "png") || ($fileextension == "bmp"))) 
									{
										$array[] += "$file";
										echo "<img style='width: 1200px;' src='https://4k-photos.co.uk/Lcyg1xRbij3xfckDV9HMlvG2vZHfhDbvoikgcXLb5Lnn7GQQcYpVGt63kDkLIkpA/$fileoriginal' alt='Christmas 1' class='center'>". "<br><hr>";
									}
							...
							else if ($countsearchterms == 3) 
							{
								while (($file = readdir($open)) !== false)
								{
									...
									if (((strpos("$file",  "$search[0]") !== false) && (strpos("$file",  "$search[1]") !== false) && (strpos("$file",  "$search[2]") !== false)) && (($fileextension == "jpg") || ($fileextension == "jpeg") || ($fileextension == "png") || ($fileextension == "bmp")))
									{
										$array[] += "$file";
										echo "<img style='width: 1200px;' src='https://4k-photos.co.uk/Lcyg1xRbij3xfckDV9HMlvG2vZHfhDbvoikgcXLb5Lnn7GQQcYpVGt63kDkLIkpA/$fileoriginal' alt='Christmas 1' class='center'>". "<br><hr>";
									}
							...
							else if ($countsearchterms == 4) 
							{
								while (($file = readdir($open)) !== false)
								{
									...
									if (((strpos("$file",  "$search[0]") !== false) && (strpos("$file",  "$search[1]") !== false) && (strpos("$file",  "$search[2]") !== false)&& (strpos("$file",  "$search[3]") !== false))&& (($fileextension == "jpg") || ($fileextension == "jpeg") || ($fileextension == "png") || ($fileextension == "bmp")))
									{
										$array[] += "$file";
										echo "<img style='width: 1200px;' src='https://4k-photos.co.uk/Lcyg1xRbij3xfckDV9HMlvG2vZHfhDbvoikgcXLb5Lnn7GQQcYpVGt63kDkLIkpA/$fileoriginal' alt='Christmas 1' class='center'>". "<br><hr>";
									}
							...
							else if ($countsearchterms == 5) 
							{
								while (($file = readdir($open)) !== false)
								{
									...
									if (((strpos("$file",  "$search[0]") !== false) && (strpos("$file",  "$search[1]") !== false) && (strpos("$file",  "$search[2]") !== false)&& (strpos("$file",  "$search[3]") !== false)	&& (strpos("$file",  "$search[4]") !== false)) && (($fileextension == "jpg") || ($fileextension == "jpeg") || ($fileextension == "png") || ($fileextension == "bmp")))
									{
										$array[] += "$file";
										echo "<img style='width: 1200px;' src='https://4k-photos.co.uk/Lcyg1xRbij3xfckDV9HMlvG2vZHfhDbvoikgcXLb5Lnn7GQQcYpVGt63kDkLIkpA/$fileoriginal' alt='Christmas 1' class='center'>". "<br><hr>";
									}
							...
							else if ($countsearchterms == 6) 
							{
								while (($file = readdir($open)) !== false)
								{
									...
									if (((strpos("$file",  "$search[0]") !== false) && (strpos("$file",  "$search[1]") !== false) && (strpos("$file",  "$search[2]") !== false)&& (strpos("$file",  "$search[3]") !== false)&& (strpos("$file",  "$search[4]") !== false) && (strpos("$file",  "$search[5]") !== false)) && (($fileextension == "jpg") || ($fileextension == "jpeg") || ($fileextension == "png") || ($fileextension == "bmp")))
									{
										$array[] += "$file";
										echo "<img style='width: 1200px;' src='https://4k-photos.co.uk/Lcyg1xRbij3xfckDV9HMlvG2vZHfhDbvoikgcXLb5Lnn7GQQcYpVGt63kDkLIkpA/$fileoriginal' alt='Christmas 1' class='center'>". "<br><hr>";
									}
							...
							else if ($countsearchterms == 7) 
							{
								while (($file = readdir($open)) !== false)
								{
									...
									if (((strpos("$file",  "$search[0]") !== false) && (strpos("$file",  "$search[1]") !== false) && (strpos("$file",  "$search[2]") !== false)&& (strpos("$file",  "$search[3]") !== false)&& (strpos("$file",  "$search[4]") !== false) && (strpos("$file",  "$search[5]") !== false) && (strpos("$file",  "$search[6]") !== false))&& (($fileextension == "jpg") || ($fileextension == "jpeg") || ($fileextension == "png") || ($fileextension == "bmp")))
										{
											$array[] += "$file";
											echo "<img style='width: 1200px;' src='https://4k-photos.co.uk/Lcyg1xRbij3xfckDV9HMlvG2vZHfhDbvoikgcXLb5Lnn7GQQcYpVGt63kDkLIkpA/$fileoriginal' alt='Christmas 1' class='center'>". "<br><hr>";
										}
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <form id="frmMemberBookNow" action="/booking/buildSessionGroup.php" method="post">
                ...
                <input type="hidden" name="categoryId" id="categoryId" value="145">
